...
def patch_ip_content(new_ip: str, domain_name: str, record_name: str, record_type: str, session: requests.Session):
...
def main():
    ...
    try:
       while True:
            ...
            webhook.send(f'<@{USER_ID}> mi ip ha cambiado! Mandando info a cloudflare...')
